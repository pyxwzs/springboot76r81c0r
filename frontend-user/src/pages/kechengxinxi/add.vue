	...
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item"  label="课程类型" prop="kechengleixing">
				<el-select v-model="ruleForm.kechengleixing" placeholder="请选择课程类型" :disabled="ro.kechengleixing"  filterable>
					<el-option
			...
			<el-form-item class="add-item" label="所属学科" prop="suoshuxueke">
				<el-input v-model="ruleForm.suoshuxueke" 
					placeholder="所属学科" clearable :readonly="ro.suoshuxueke"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="学分" prop="xuefen">
				<el-input v-model="ruleForm.xuefen" 
					placeholder="学分" clearable :readonly="ro.xuefen"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="总课时" prop="zongkeshi">
				<el-input v-model="ruleForm.zongkeshi" 
					placeholder="总课时" clearable :readonly="ro.zongkeshi"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="授课教师" prop="shoukejiaoshi">
				<el-input v-model="ruleForm.shoukejiaoshi" 
					placeholder="授课教师" clearable :readonly="ro.shoukejiaoshi"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="授课时间" prop="shoukeshijian">
				<el-input v-model="ruleForm.shoukeshijian" 
					placeholder="授课时间" clearable :readonly="ro.shoukeshijian"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="授课地点" prop="shoukedidian">
				<el-input v-model="ruleForm.shoukedidian" 
					placeholder="授课地点" clearable :readonly="ro.shoukedidian"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="课程视频" v-if="type!='cross' || (type=='cross' && !ro.kechengshipin)" prop="kechengshipin">
				<file-upload
					tip="点击上传课程视频"
					action="file/upload"
					:limit="1"
			...
			<el-form-item class="add-item" v-else label="课程视频" prop="kechengshipin">
				<div class="viewBtn" v-if="ruleForm.kechengshipin" @click="download(baseUrl + ruleForm.kechengshipin )" type="success">预览</div>
		...
		methods: {
			...
			init(type) {
				...
				if(type=='cross'){
					...
					this.ruleForm.onshelves = Number('1'); 				}else if(type=='edit'){
					this.info()
				}
				// 获取用户信息
			...
			// 多级联动参数
			async info() {
				await this.$http.get(`kechengxinxi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
