			...
			init() {
				...
				this.$http.get(this.tablename + '/detail/'  + this.id, {}).then(async res => {
					if (res.data.code == 0) {
						...
						this.detailBanner = [res.data.data.picture1,res.data.data.picture2,res.data.data.picture3].filter(Boolean)
						if(!this.detailBanner.length){
							this.detailBanner = [
								'upload/systemintro_picture1.jpg',
								'upload/systemintro_picture2.jpg',
								'upload/systemintro_picture3.jpg',
							]
						}
						this.$forceUpdate();
