...
<style lang="scss">
	...
	:root {
		--theme-font: "PingFang SC", "Microsoft YaHei", sans-serif;
		--theme-bg: #07111f;
		--theme-surface: rgba(10, 23, 39, 0.82);
		--theme-surface-strong: rgba(12, 28, 48, 0.94);
		--theme-card: rgba(255, 255, 255, 0.88);
		--theme-card-soft: rgba(255, 255, 255, 0.72);
		--theme-border: rgba(120, 203, 255, 0.24);
		--theme-text: #eaf6ff;
		--theme-text-dark: #18324b;
		--theme-muted: #7f96ad;
		--theme-primary: #52d0ff;
		--theme-secondary: #7ef5d4;
		--theme-accent: #6a7cff;
		--theme-shadow: 0 24px 60px rgba(5, 17, 31, 0.24);
	}
	...
	* {
	...
	body {
		...
		background:
			radial-gradient(circle at top, rgba(82, 208, 255, 0.16), transparent 32%),
			radial-gradient(circle at 85% 12%, rgba(126, 245, 212, 0.16), transparent 28%),
			linear-gradient(180deg, #07111f 0%, #0a1729 36%, #eef5fb 100%);
	...
	.breadcrumb-preview .el-breadcrumb .item1 .el-breadcrumb__inner a {
		padding: 0 0 0 72px;
		color: #333;
		background: url(http://codegen.caihongy.cn/20251212/a56c927c281f491a93aa8a094adf8fa9.png) no-repeat left center;
