			...
			<el-form class="center-form-pv" :style='{"width":"100%","padding":"0","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"5px 10px 10px 20px","boxShadow":"0 1px 5px -3px #00000010, 0 4px 6px -4px #00000010","borderRadius":"10px","alignItems":"center","flexWrap":"wrap","background":"#fff","display":"inline-block","width":"100%","position":"relative"}' >
					<div  :style='{"width":"auto","margin":"0 5px 10px 0","flexDirection":"column","display":"inline-block"}'>
						...
						<el-input v-model="searchForm.papername" placeholder="试卷名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
				...
				<el-row class="actions" :style='{"width":"calc(100% + 8px)","margin":"20px 0 20px -4px","flexWrap":"wrap","display":"flex"}'>
					<el-button class="add" v-if="isAuth('examstatistics','新增')" type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia1" :style='{"margin":"0 2px","fontSize":"14px","color":"inherit","height":"40px"}'></span>
						添加
					</el-button>
					<el-button class="del" v-if="isAuth('examstatistics','删除')" :disabled="dataListSelections.length?false:true" type="danger" @click="deleteHandler()">
						<span class="icon iconfont icon-shanchu6" :style='{"margin":"0 2px","fontSize":"16px","color":"inherit","height":"40px"}'></span>
						批量删除
					</el-button>


					<el-button class="btn18" v-if="isAuth('examstatistics','试卷平均成绩')" type="success" @click="chartDialogShow1">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"16px","color":"inherit","height":"40px"}'></span>
						试卷平均成绩
					</el-button>
					<el-button class="btn18" v-if="isAuth('examstatistics','成绩区间分布')" type="success" @click="chartDialogShow2">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"16px","color":"inherit","height":"40px"}'></span>
						成绩区间分布
					</el-button>
					<el-button class="btn18" v-if="isAuth('examstatistics','学生平均成绩')" type="success" @click="chartDialogShow3">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"16px","color":"inherit","height":"40px"}'></span>
						学生平均成绩
					</el-button>
				</el-row>
			...
			<div :style='{"width":"100%","padding":"0","boxShadow":"0 2px 2px -3px #00000010, 0 2px 2px -2px #00000010","borderRadius":"12px"}'>
				<el-table class="tables"
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button class="edit" v-if=" isAuth('examstatistics','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
							...
							<el-button class="del" v-if="isAuth('examstatistics','删除')" type="primary" @click="deleteHandler(scope.row.id)">
		...
		methods: {
			...
			chartDialog1() {
				this.$nextTick(()=>{
					...
					params.func = '平均'
					this.$http({
						url: "examstatistics/value/papername/totalscore",
						method: "get",
						params
					}).then(({data})=>{
						if (data && data.code === 0) {
			...
			getDataList() {
				...
				if(this.searchForm.papername!='' && this.searchForm.papername!=undefined){
					params['papername'] = '%' + this.searchForm.papername + '%'
				}
				let user = JSON.parse(this.$storage.getObj('userForm'))
				this.$http({
					url: "examstatistics/page",
					method: "get",
					params: params
				}).then(({ data }) => {
					if (data && data.code === 0) {
