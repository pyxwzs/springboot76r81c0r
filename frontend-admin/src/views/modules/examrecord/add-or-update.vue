<template>
	<div class="main-content" :style='{"width":"100%","padding":"30px","background":"#f9fafb"}'>
		<!-- 列表页 -->
		<div v-if="!showFlag">
			<el-form :style='{"padding":"50px 20% 30px 10%","boxShadow":"0 1px 4px -1px rgba(0, 0, 0, .1),0 2px 2px -2px rgba(0, 0, 0, .1)","borderRadius":"10px","flexWrap":"wrap","background":"#fff","display":"flex"}' :inline="true" :model="searchForm" class="add-update-preview">
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="试卷名称">
					<el-input v-model="searchForm.papername" placeholder="试卷名称" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' label="试题名称">
