		...
		<template v-if="!showFlag">
			<el-form :style='{"width":"100%","padding":"0","margin":"0 0 20px"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"padding":"5px 10px 10px 20px","boxShadow":"0 1px 5px -3px #00000010, 0 4px 6px -4px #00000010","borderRadius":"10px","alignItems":"center","flexWrap":"wrap","background":"#fff","display":"inline-block","width":"100%","position":"relative"}'>
					<div :style='{"width":"auto","margin":"0 5px 10px 0","flexDirection":"column","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label"></label>
						<el-input v-model="searchForm.questionname" placeholder="" clearable></el-input>
					</div>
				...
				<el-row class="actions" :style='{"width":"calc(100% + 8px)","margin":"20px 0 20px -4px","flexWrap":"wrap","display":"flex"}'>
					<el-button v-if="isAuth('examquestionbank','新增')" class="add" :style='{"border":"0px solid #6c63ff80","cursor":"pointer","padding":"0 15px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":"#165dff","width":"auto","fontSize":"14px","height":"34px"}' type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia1" :style='{"margin":"0 2px","fontSize":"14px","color":"inherit","height":"40px"}'></span>
						添加
					</el-button>
					<el-button v-if="isAuth('examquestionbank','删除')" class="del" :disabled="dataListSelections.length <= 0" :style='{"border":"0px solid #6c63ff80","cursor":"pointer","padding":"0 10px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":"#ff4d4f","width":"auto","fontSize":"14px","height":"34px"}' type="danger" @click="deleteHandler()">
			...
			<div :style='{"width":"100%","padding":"0","boxShadow":"0 2px 2px -3px #00000010, 0 2px 2px -2px #00000010","borderRadius":"12px"}'>
				...
				>
					...
					>
						<template slot-scope="scope">
							<el-button v-if="isAuth('examquestionbank','修改')" class="edit" :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#36cfc9","width":"auto","fontSize":"14px","height":"32px","order":"-1"}' type="success" @click="addOrUpdateHandler(scope.row.id)">
								<span class="icon iconfont icon-xiugai13" :style='{"margin":"0 0px","fontSize":"14px","color":"inherit","height":"40px"}'></span>
								修改
							</el-button>
							<el-button v-if="isAuth('examquestionbank','删除')" class="del" :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#dc2626","width":"auto","fontSize":"14px","height":"32px"}' type="primary" @click="deleteHandler(scope.row.id)">
