...
<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="隐患编号" prop="yinhuanbianhao" >
					<el-input v-model="ruleForm.yinhuanbianhao" placeholder="隐患编号" clearable  :readonly="ro.yinhuanbianhao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="隐患编号" prop="yinhuanbianhao" >
					<el-input v-model="ruleForm.yinhuanbianhao" placeholder="隐患编号" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="隐患名称" prop="yinhuanmingcheng" >
					<el-input v-model="ruleForm.yinhuanmingcheng" placeholder="隐患名称" clearable  :readonly="ro.yinhuanmingcheng"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="隐患名称" prop="yinhuanmingcheng" >
					<el-input v-model="ruleForm.yinhuanmingcheng" placeholder="隐患名称" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="隐患类型" prop="yinhuanleixing" >
					<el-input v-model="ruleForm.yinhuanleixing" placeholder="隐患类型" clearable  :readonly="ro.yinhuanleixing"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="隐患类型" prop="yinhuanleixing" >
					<el-input v-model="ruleForm.yinhuanleixing" placeholder="隐患类型" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="隐患位置" prop="yinhuanweizhi" >
					<el-input v-model="ruleForm.yinhuanweizhi" placeholder="隐患位置" clearable  :readonly="ro.yinhuanweizhi"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="隐患位置" prop="yinhuanweizhi" >
					<el-input v-model="ruleForm.yinhuanweizhi" placeholder="隐患位置" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="隐患等级" prop="yinhuandengji" >
					<el-input v-model="ruleForm.yinhuandengji" placeholder="隐患等级" clearable  :readonly="ro.yinhuandengji"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="隐患等级" prop="yinhuandengji" >
					<el-input v-model="ruleForm.yinhuandengji" placeholder="隐患等级" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="处理结果" prop="chulijieguo" >
					<el-input v-model="ruleForm.chulijieguo" placeholder="处理结果" clearable  :readonly="ro.chulijieguo"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="处理结果" prop="chulijieguo" >
					<el-input v-model="ruleForm.chulijieguo" placeholder="处理结果" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'" class="editorBox" label="隐患内容" prop="yinhuanneirong" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.yinhuanneirong" label="隐患内容" prop="yinhuanneirong"  class="textBox">
				<span class="text ql-snow ql-editor" v-html="ruleForm.yinhuanneirong"></span>
			</el-form-item>
		...
		methods: {
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.yinhuandengji = '四级'; 				}
				// 获取用户信息
				this.$http({
			...
			async info(id) {
				await this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.yinhuanneirong = this.ruleForm.yinhuanneirong.replace(reg,'../../../springboot76r81c0r/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `chuzhifankui/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.chuzhifankuiCrossAddOrUpdateFlag = false;
											this.parent.search();
										}
									});
								} else {
