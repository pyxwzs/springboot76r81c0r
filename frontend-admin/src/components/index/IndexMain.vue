<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0 0 0 250px","margin":"0","position":"relative","background":"#f9fafb","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 0px #eee","padding":"8px 20px","alignItems":"center","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"center","zIndex":"1"}'></index-header>
			...
			<template v-if="'vertical' == 'vertical'">
			  ...
			  <template v-if="2 == 2">
				<index-aside :is-collapse="isCollapse" @oncollapsechange="collapseChange" :style='isCollapse ? {"boxShadow":"1px 0 0px  rgba(0, 0, 0, .1)","overflow":"hidden","top":"0","left":"0","background":"#fff","bottom":"0","width":"64px","fontSize":"0px","position":"fixed","transition":"width 0.3s","height":"100%","zIndex":"1001"} : {"boxShadow":"0px 0 3px  #ddd","overflow":"hidden","top":"0","left":"0","background":"#1e293b","bottom":"0","width":"250px","position":"fixed","transition":"width 0.3s","height":"100%","zIndex":"1001"}'></index-aside>
			  </template>
			</template>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"width":"calc(100% - 60px)","padding":"0","margin":"15px auto 0 auto","borderColor":"#ddd","borderStyle":"solid","borderWidth":"0 0 0px 0"}' class="bread-crumbs"></bread-crumbs>
