...
public class XuexijiluServiceImpl extends ServiceImpl<XuexijiluDao, XuexijiluEntity> implements XuexijiluService {
    ...
    @Override
    public List<Map<String, Object>> kechengmingchengwanchengqingkuangTypeStat(Map<String, Object> params, Wrapper<XuexijiluEntity> wrapper) {
        return baseMapper.kechengmingchengwanchengqingkuangTypeStat(params, wrapper);
    }
