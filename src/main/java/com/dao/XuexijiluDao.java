...
public interface XuexijiluDao extends BaseMapper<XuexijiluEntity> {
    ...
    List<Map<String, Object>> selectValue(@Param("params") Map<String, Object> params,@Param("ew") Wrapper<XuexijiluEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(@Param("params") Map<String, Object> params,@Param("ew") Wrapper<XuexijiluEntity> wrapper);

    List<Map<String, Object>> selectGroup(@Param("params") Map<String, Object> params,@Param("ew") Wrapper<XuexijiluEntity> wrapper);


    List<Map<String, Object>> kechengmingchengwanchengqingkuangTypeStat(@Param("params") Map<String, Object> params,@Param("ew") Wrapper<XuexijiluEntity> wrapper);
